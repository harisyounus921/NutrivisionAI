...
/// Backward-compatible base class used by current FlutterFire packages.
///
/// The hosted 7.1.0 interface exposes [FirebasePluginPlatform], while several
/// Firebase packages in the same release train still import [FirebasePlugin].
/// Keep this alias locally until FlutterFire publishes a corrected release.
abstract class FirebasePlugin extends FirebasePluginPlatform {
  FirebasePlugin(String appName, String methodChannelName)
      : super(appName, methodChannelName);
}
